  ...
  const reviews = [
    {
      ...
      content: "The Digital Coaching Retreat was a game-changer for me. Before joining, I felt lost and overwhelmed, unsure of my true goals and potential. Within just two weeks, I gained incredible clarity about what I really wanted in both my personal and professional life and realised I had been stuck for a while without even noticing."
    },
    {
      name: "Rachel Martinez",
      role: "Senior Manager",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=150&h=150&q=80",
      content: "I often felt overwhelmed with so many things to consider in life, but the lessons on prioritisation helped me focus on what truly matters. Overall, the courses were incredibly helpful and informative, and I feel more empowered to manage my goals."
    },
    {
      name: "Thomas Chen",
      role: "Project Lead",
      image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&h=150&q=80",
      content: "I often feel trapped in the corporate routine, stuck doing the same tasks even after my promotion. Deep down, I know I'm meant for more, but fear of new challenges keeps me from reaching my full potential. This journey has helped me see my weaknesses as opportunities for growth. I'm learning to take control of my life and now have a clearer idea of what I want to achieve."
    },
    {
      name: "Sarah Williams",
      role: "Business Owner",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&h=150&q=80",
      content: "The videos made it clear why I felt stuck and sparked a strong desire for change, pushing me to step out of my comfort zone. Now, I have a clearer direction and a solid plan to make my goals a reality, not just another list of dreams. What I really love is how this program speaks to everyone from all walks of life."
    }
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {reviews.map((review, index) => (
            ...
            >
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">{review.content}</p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#c8b6a6] font-medium">{review.role}</p>
                </div>
              </div>
            </div>
          ))}
