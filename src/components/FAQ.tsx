...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "If you're unsure, ask yourself: Am I happy staying where I am? This workshop is your chance to create clarity and take the first step toward real change."
    },
    {
      question: "What if I don't like the workshop?",
      answer: "We're confident in the transformation this workshop can bring. If you're not satisfied, reach out to us within 7 days, and we'll make it right."
    }
  ];
